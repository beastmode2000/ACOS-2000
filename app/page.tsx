...
const defaultLocations: LocationRecord[] = [
  {
    ...
    type: "Property",
    zone: "2000",
    notes: "Whole-estate default location for records not tied to one room or asset.",
  },
  {
    id: "original-house",
    name: "Original House",
  ...
  },
  {
    ...
    type: "Building",
    zone: "Main House",
    notes: "Addition wing including the indoor pool area.",
  },
  {
    id: "mechanical-room",
    ...
    type: "Systems",
    zone: "Main House",
    notes: "Boilers, DHW tanks, hydronic controls, pumps, pool heat, and HVAC equipment.",
  },
  {
    id: "pool-equipment",
    ...
    type: "Pool Systems",
    zone: "Addition",
    notes: "Pool filtration, pumps, UV/ozone, Desert Aire, and hydronic pool heat equipment.",
  },
  {
    id: "standalone-spa",
    ...
    type: "Spa",
    zone: "Outdoor",
    notes: "Standalone Sundance 880 Optima spa. Separate from pool equipment.",
  },
  {
    id: "dock",
    name: "Dock",
    type: "Waterfront",
    zone: "Lake",
    notes: "Main dock, boat lift areas, dock power, Sea-Doo area, Cobalt, and lift control boxes.",
  },
  {
    id: "cobalt-lift",
    name: "Cobalt Lift",
  ...
  },
  {
    ...
    type: "Lift Controls",
    zone: "Dock",
    notes: "Additional dock lift box. Keep separate from Cobalt and Sea-Doo lift boxes.",
  },
  {
    id: "water-trampoline",
  ...
  },
  {
    ...
    type: "Grounds",
    zone: "East",
    notes: "Three vegetable boxes at the south end of East Lawn near New Garage.",
  },
  {
    id: "new-garage",
    name: "New Garage",
  ...
  },
  {
    ...
    notes: "ADU is a location/map label, not an asset.",
  },
  {
    id: "courtyard",
    name: "Courtyard",
  ...
  },
  {
    ...
    type: "Grounds",
    zone: "Exterior",
    notes: "Turf/trampoline/dog cleanup area east of the covered hallway.",
  },
  {
    id: "exterior",
    name: "Exterior",
    type: "Envelope",
    zone: "2000",
    notes: "Exterior paint/stain, siding, eaves, deck edges, windows, and envelope checks.",
  },
  {
    id: "irrigation",
    name: "Irrigation",
    ...
    zone: "Grounds",
    notes: "Hunter Hydrawise / Advanced Irrigation records, zones, flow/rain/soil sensors.",
  },
];
...
const defaultMapLabels: MapLabelRecord[] = [
  {
    ...
    x: 58,
    y: 78,
    notes: "Main dock location with boat lifts, dock power, and waterfront service records.",
    photos: [],
  },
  {
    id: "map-cobalt",
    ...
    x: 63,
    y: 72,
    notes: "Cobalt R7 area near the dock. Keep separate from the Cobalt Sunstream lift box asset.",
    photos: [],
  },
  {
    id: "map-seadoo",
  ...
  },
  {
    ...
    x: 77,
    y: 62,
    notes: "Three veggie boxes at the south end of East Lawn next to New Garage.",
    photos: [],
  },
  {
    id: "map-new-garage",
  ...
  },
  {
    ...
    x: 47,
    y: 44,
    notes: "Courtyard patio with chairs/fire pit. West of the gray covered hallway.",
    photos: [],
  },
  {
    ...
    x: 42,
    y: 56,
    notes: "Green turf/trampoline/dog area east of the covered hallway.",
    photos: [],
  },
  {
  ...
  },
  {
    ...
    x: 61,
    y: 51,
    notes: "Standalone Sundance 880 spa on patio east of furniture/stairs to lawn.",
    photos: [],
  },
];
...
const defaultVendors: VendorRecord[] = [
  ...
  },
  {
    ...
    notes: "Boilers, hydronic heating, HVAC, Desert Aire, pool mechanical, and related systems.",
  },
  {
    id: "seattleboat",
    name: "Seattle Boat",
  ...
  {
    id: "i90motorsports",
    name: "I-90 Motorsports",
    category: "PWC / Motorsports",
    notes: "Sea-Doo service / PWC support.",
  },
  {
    id: "sunstream",
    name: "Sunstream Boat Lifts",
    category: "Dock / Lifts",
    notes: "Sunstream lift boxes and boat/PWC lift records.",
  },
  {
    id: "penthousedrapery",
    ...
    notes: "Motorized roller shades. Invoice #176396 dated 06/16/2026.",
  },
  {
    id: "unrivaled",
    name: "Unrivaled",
    category: "Pest Control",
    notes: "Current pest-control vendor. Terminix was canceled.",
  },
  {
    id: "peterclark",
    name: "Peter Clark Designs",
    category: "Landscaping",
    notes: "Weekly landscaping/weeding crew approved by Steve and managed by Pat.",
  },
  {
    id: "applianceservice",
    name: "Appliance Service Station",
    category: "Appliances",
    notes: "Appliance service vendor.",
  },
];
...
const defaultAssets: AssetRecord[] = [
  ...
  },
  {
    ...
    notes: "Two 79 USG / 300 L stainless indirect domestic hot water tanks.",
    vendorIds: ["psf"],
  },
  {
    id: "desertaire-dhu1",
    ...
    status: "Monitor",
    make: "Desert Aire",
    notes: "Indoor pool dehumidification system with hydronic heat coil and controls.",
    vendorIds: ["psf"],
  },
  {
    ...
    status: "Online",
    make: "Pentair",
    notes: "Pool source → pump → Triton II sand filter → UV/ozone → return to pool.",
    vendorIds: ["psf"],
  },
  {
    id: "sundance-optima",
  ...
  },
  {
    ...
    status: "Monitor",
    make: "Sunstream",
    notes: "Sea-Doo lift box. Smaller/older Sunstream box. Keep separate from Cobalt lift box.",
    vendorIds: ["sunstream"],
  },
  {
    id: "sunstream-dock",
    ...
    status: "Monitor",
    make: "Sunstream",
    notes: "Additional smaller/older dock lift control box.",
    vendorIds: ["sunstream"],
  },
  {
    id: "craft-cobalt",
    ...
    make: "Cobalt",
    model: "R7",
    notes: "Cobalt R7 watercraft record connected to dock and newer Sunstream Cobalt lift box.",
    vendorIds: ["seattleboat", "sunstream"],
  },
  {
    id: "craft-seadoo",
    name: "Craft — SeaDoo 2024 GTI SE 170",
    locationId: "dock",
    category: "Watercraft",
    status: "Seasonal",
    make: "Sea-Doo",
    model: "GTI SE 170",
    notes: "2024 Sea-Doo record connected to dock and Sea-Doo lift records.",
  ...
  },
  {
    ...
    status: "Monitor",
    make: "Lutron",
    notes: "Motorized roller shade asset. Penthouse Drapery invoice #176396 belongs here.",
    vendorIds: ["penthousedrapery"],
  },
  {
    id: "dishwasher-dw3",
    ...
    status: "Online",
    make: "Bosch",
    notes: "Kitchen right Bosch dishwasher.",
    vendorIds: ["applianceservice"],
  },
  {
    id: "exterior-stain",
    name: "Exterior Stain Scope",
    locationId: "exterior",
    category: "Exterior",
    status: "Monitor",
    notes:
...
const defaultWorkOrders: ServiceRecord[] = [
  {
    id: "wo-weekly-dock",
    assetId: "craft-cobalt",
    vendorId: "seattleboat",
    date: todayISO(),
    title: "Weekly dock / boat / Sea-Doo check",
    status: "Open",
    priority: "Medium",
    notes: "Check Cobalt, Sea-Doo, lifts, dock power, water trampoline, and waterfront equipment.",
  },
  {
    id: "wo-pool-weekly",
    ...
    vendorId: "psf",
    date: todayISO(),
    title: "Weekly pool / spa water and equipment check",
    status: "Open",
    priority: "High",
    notes: "Record pool/spa readings, filter pressure, equipment status, and any issues.",
  },
  {
    id: "wo-exterior-stain",
    assetId: "exterior-stain",
    vendorId: "elliottpaint",
    date: "2026-07-08",
    title: "Exterior stain scope tracking",
    status: "Monitor",
    priority: "High",
    notes: "Track semi-transparent vs semi-solid scope, Jessica approval items, and progress photos.",
  },
  {
...
const defaultProcedures: ProcedureRecord[] = [
  {
    ...
    priority: "High",
    steps: [
      "Record current filter pressure.",
      ...
      "Record final pressure and issues.",
    ],
  },
  {
    id: "spa-weekly",
    title: "Sundance Spa Weekly Check",
    area: "Hot Tub / Sundance",
    priority: "Normal",
    steps: [
      "Check water level and temperature.",
      "Test sanitizer, pH, alkalinity.",
      "Confirm ClearRay / heater / circulation status.",
      "Clean cover and surrounding area.",
      "Log readings and follow-up items.",
    ],
  },
  {
    id: "out-of-town",
    title: "Out-of-Town Property Check",
    area: "2000",
    priority: "High",
    steps: [
      "Confirm doors, windows, alarms, and leak-prone areas.",
      "Check mechanical rooms for abnormal readings/noise.",
      "Check pool/spa/fountain/dock areas.",
      "Confirm vendor access and deliveries.",
      "Send summary to Steve if needed.",
    ],
  },
];
...
const defaultDocuments: DocumentRecord[] = [
  {
    id: "property-map",
    title: "Locked Atlas Property Map",
    area: "Map",
    type: "Image",
    href: "/atlas-property-map.png",
    notes: "Fixed original property map image used by Atlas labels.",
  },
  {
    id: "stain-plan",
    ...
    area: "Exterior",
    type: "Scope",
    linkedAssetId: "exterior-stain",
    notes: "Client-facing stain scope summary for Jessica approval.",
  },
  {
    ...
    notes: "Repair one motorized roller shade; two trips and replacement drive.",
  },
];

const defaultParts: PartRecord[] = [
  {
    id: "filters-mr1-16x16",
    name: "MR1 1x16x16 Columbia Filters",
  ...
  {
    id: "pool-test-reagents",
    name: "Taylor Pool Test Reagents",
    category: "Pool Testing",
    locationId: "pool-equipment",
    quantity: 1,
    minQuantity: 1,
    status: "In Stock",
    notes: "Keep pool testing supplies stocked.",
  },
];
...
const blankMapLabel: MapLabelRecord = {
  id: "",
  label: "",
  category: "Location",
  x: 50,
...
export default function AtlasPage() {
  ...
  useEffect(() => {
    ...
    setServiceRecords(
      readStoredArray<ServiceRecord>(storageKeys.workOrders, defaultWorkOrders)
    );
  ...
  const selectedMapLabel =
    mapLabels.find((label) => label.id === selectedMapLabelId) ??
    mapLabels[0] ??
    defaultMapLabels[0];
  ...
  const sortedLocations = useMemo(
    () => [...defaultLocations].sort((a, b) => a.name.localeCompare(b.name)),
    []
  );

  const sortedAssets = useMemo(
    () => [...assetRecords].sort((a, b) => a.name.localeCompare(b.name)),
    [assetRecords]
  );

  const sortedVendors = useMemo(
    () => [...vendorRecords].sort((a, b) => a.name.localeCompare(b.name)),
    [vendorRecords]
  );
      ...
      [...serviceRecords].sort(
        (a, b) =>
          (a.status === "Completed" ? 1 : 0) -
            (b.status === "Completed" ? 1 : 0) || a.date.localeCompare(b.date)
      ),
    [serviceRecords]
  );
  ...
  function buildSearchIndex(): SearchResult[] {
    return [
      ...
      ...partRecords.map((part) => ({
        ...
        detail: `${locationName(part.locationId)} · Qty ${part.quantity} / min ${
          part.minQuantity
        }. ${part.notes}`,
  ...
  function updateMapLabelPosition(id: string, clientX: number, clientY: number) {
    ...
    setMapLabels((current) =>
      current.map((label) =>
        label.id === id ? { ...label, x: nextX, y: nextY } : label
      )
    );

    setMapLabelForm((current) =>
  ...
  function saveMapLabel() {
    ...
    setMapLabels((current) =>
      current.some((label) => label.id === id)
        ? current.map((label) => (label.id === id ? cleanLabel : label))
        : [...current, cleanLabel]
    );
    ...
    files.forEach((file) => {
      ...
      reader.onload = () => {
        ...
        setMapLabels((current) =>
          current.map((label) =>
            label.id === labelId
              ? { ...label, photos: [photo, ...(label.photos ?? [])] }
              : label
          )
        );
    ...
    setMapLabels((current) =>
      current.map((label) =>
        label.id === labelId
          ? {
              ...label,
              photos: (label.photos ?? []).filter((photo) => photo.id !== photoId),
            }
          : label
      )
    );
  ...
  function addWorkOrderFromMapLabel(label: MapLabelRecord) {
    const matchingAsset =
      assetRecords.find((asset) => asset.locationId === label.id.replace("map-", "")) ??
      assetRecords[0];
    ...
    const record: ServiceRecord = {
      ...
      priority: "Medium",
      notes: label.notes
        ? `Created from map label. ${label.notes}`
        : "Created from map label.",
    };
  ...
  function updateAsset(id: string, changes: Partial<AssetRecord>) {
    setAssetRecords((current) =>
      current.map((asset) => (asset.id === id ? { ...asset, ...changes } : asset))
    );
  }
  ...
  function updateVendor(id: string, changes: Partial<VendorRecord>) {
    setVendorRecords((current) =>
      current.map((vendor) => (vendor.id === id ? { ...vendor, ...changes } : vendor))
    );
  }
        ...
        >
          {screens.map((item) => (
            <button
              ...
              style={
                screen === item.id
                  ? { ...navButtonStyle, ...navButtonActiveStyle }
                  : navButtonStyle
              }
            >
              {item.label}
      ...
      <Section
        ...
        right={
          <div style={buttonRowStyle}>
            ...
            <button type="button" onClick={startNewMapLabel} style={goldButtonStyle}>
              Add Label
            </button>
            <button type="button" onClick={resetMapLabels} style={dangerButtonStyle}>
              Reset Map
            </button>
          </div>
        }
        ...
        >
          ...
          <div style={recordCardStyle}>
            ...
            <div style={formGridStyle}>
              ...
              <div style={buttonRowStyle}>
                <button type="button" onClick={saveMapLabel} style={goldButtonStyle}>
                  Save Label
                </button>
                <button
                  type="button"
                  onClick={() => addWorkOrderFromMapLabel(mapLabelForm)}
                  style={secondaryButtonStyle}
                >
                  Create WO
                </button>
                <button type="button" onClick={deleteMapLabel} style={dangerButtonStyle}>
                  Delete
                </button>
              </div>
                ...
                <div style={photoGridStyle}>
                  {mapLabelForm.photos.map((photo) => (
                    <div key={photo.id} style={photoCardStyle}>
                      ...
                      <button
                        type="button"
                        onClick={() => deleteMapPhoto(photo.id)}
  ...
  function renderLocations() {
    const visible = sortedLocations.filter(
      (location) =>
        !searchText ||
      ...
      <Section title="Locations" eyebrow="Alphabetized / related assets">
        <div style={listGridStyle}>
          {visible.map((location) => {
            const relatedAssets = assetRecords.filter(
  ...
  function renderAssets() {
    const visible = sortedAssets.filter(
      (asset) =>
        !searchText ||
        `${asset.name} ${asset.category} ${locationName(asset.locationId)} ${asset.notes}`
          .toLowerCase()
          .includes(searchText)
    );
              ...
              <button
                ...
                style={
                  selectedAssetId === asset.id
                    ? { ...rowButtonStyle, borderColor: colors.gold, background: "#FFF9EA" }
                    : rowButtonStyle
                }
              >
                <div>
          ...
          <div style={formGridStyle}>
            <label style={labelStyle}>
              ...
              <input
                ...
                onChange={(event) =>
                  updateAsset(selectedAsset.id, { name: event.target.value })
                }
                style={inputStyle}
              />
            </label>
            ...
            <label style={labelStyle}>
              ...
              <select
                ...
                onChange={(event) =>
                  updateAsset(selectedAsset.id, { locationId: event.target.value })
                }
                style={inputStyle}
              >
                {sortedLocations.map((location) => (
            ...
            <label style={labelStyle}>
              ...
              <input
                ...
                onChange={(event) =>
                  updateAsset(selectedAsset.id, { category: event.target.value })
                }
                style={inputStyle}
              />
            </label>
            ...
            <label style={labelStyle}>
              ...
              <select
                ...
                style={inputStyle}
              >
                {["Online", "Offline", "Seasonal", "Monitor"].map((status) => (
            ...
            <label style={labelStyle}>
              ...
              <textarea
                ...
                onChange={(event) =>
                  updateAsset(selectedAsset.id, { notes: event.target.value })
                }
                style={textareaStyle}
              />
            </label>
          ...
          <div style={formGridStyle}>
            <label style={labelStyle}>
              ...
              <input
                ...
                onChange={(event) =>
                  updateWorkOrder(selectedService.id, { title: event.target.value })
                }
                style={inputStyle}
              />
            </label>
            ...
            <label style={labelStyle}>
              ...
              <select
                ...
                onChange={(event) =>
                  updateWorkOrder(selectedService.id, { assetId: event.target.value })
                }
                style={inputStyle}
              >
                {assetRecords.map((asset) => (
            ...
            <label style={labelStyle}>
              ...
              <select
                ...
                onChange={(event) =>
                  updateWorkOrder(selectedService.id, { vendorId: event.target.value })
                }
                style={inputStyle}
              >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              <label style={labelStyle}>
                ...
                <select
                  ...
                  onChange={(event) =>
                    updateWorkOrder(selectedService.id, {
                      status: event.target.value as ServiceStatus,
                    })
                  }
                  style={inputStyle}
                >
                  {["Open", "Scheduled", "Completed", "Monitor"].map((status) => (
                    <option key={status} value={status}>
                      {status}
                    </option>
                  ))}
            ...
            <label style={labelStyle}>
              ...
              <input
                ...
                onChange={(event) =>
                  updateWorkOrder(selectedService.id, { date: event.target.value })
                }
                style={inputStyle}
              />
            </label>
            ...
            <label style={labelStyle}>
              ...
              <textarea
                ...
                onChange={(event) =>
                  updateWorkOrder(selectedService.id, { notes: event.target.value })
                }
                style={textareaStyle}
              />
            </label>
          ...
          <div style={formGridStyle}>
            <label style={labelStyle}>
              ...
              <input
                ...
                onChange={(event) =>
                  updateVendor(selectedVendor.id, { name: event.target.value })
                }
                style={inputStyle}
              />
            </label>
            ...
            <label style={labelStyle}>
              ...
              <input
                ...
                onChange={(event) =>
                  updateVendor(selectedVendor.id, { category: event.target.value })
                }
                style={inputStyle}
              />
            </label>
            ...
            <label style={labelStyle}>
              ...
              <input
                ...
                onChange={(event) =>
                  updateVendor(selectedVendor.id, { phone: event.target.value })
                }
                style={inputStyle}
              />
            </label>
            ...
            <label style={labelStyle}>
              ...
              <input
                ...
                onChange={(event) =>
                  updateVendor(selectedVendor.id, { email: event.target.value })
                }
                style={inputStyle}
              />
            </label>
            ...
            <label style={labelStyle}>
              ...
              <textarea
                ...
                onChange={(event) =>
                  updateVendor(selectedVendor.id, { notes: event.target.value })
                }
                style={textareaStyle}
              />
            </label>
  ...
  function renderCalendar() {
    return (
      <Section title="Calendar" eyebrow="Scheduled items">
        <div style={listGridStyle}>
          {calendarItems.map((item) => (
            <div key={item.id} style={recordCardStyle}>
  ...
  function renderWeather() {
    return (
      <Section title="Weather" eyebrow="Property planning">
        <div style={emptyStateStyle}>
          Weather planning placeholder. Keep using this tab for rain, wind, lake,
          exterior stain, irrigation, and dock planning notes.
        </div>
      </Section>
    );
  }
        ...
        <div style={listGridStyle}>
          {defaultDocuments.map((doc) => (
            <div key={doc.id} style={recordCardStyle}>
              ...
              {doc.href ? (
                <a href={doc.href} style={linkStyle}>
                  Open
                </a>
              ) : null}
            </div>
            ...
            <div key={procedure.id} style={recordCardStyle}>
              ...
              <ol style={{ margin: "10px 0 0", paddingLeft: 20 }}>
                {procedure.steps.map((step, index) => (
                  <li key={`${procedure.id}-${index}`} style={bodyTextStyle}>
                    {step}
                  </li>
                ))}
              </ol>
        ...
        <div style={listGridStyle}>
          {partRecords.map((part) => (
            <div key={part.id} style={recordCardStyle}>
              ...
              <p style={mutedSmallStyle}>
                {part.category} · {locationName(part.locationId)}
              </p>
              <p style={bodyTextStyle}>
                Qty {part.quantity} / min {part.minQuantity}
              </p>
        ...
        <div style={formGridStyle}>
          <label style={labelStyle}>
            ...
            <textarea
              ...
              placeholder="Example: where is the ADU, what is high priority, who handles irrigation..."
              style={textareaStyle}
            />
          </label>
...
const searchPanelStyle: React.CSSProperties = {
  ...
  border: `1px solid ${colors.line}`,
  borderRadius: 14,
  boxShadow: "0 18px 40px rgba(11,30,51,.18)",
  padding: 8,
  zIndex: 30,
  maxHeight: 420,
  overflowY: "auto",
...
const sectionStyle: React.CSSProperties = {
  ...
  borderRadius: 18,
  padding: 16,
  boxShadow: "0 10px 24px rgba(11,30,51,.06)",
};
