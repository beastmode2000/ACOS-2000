          ...
          <div>
            ...
            <section style={styles.card}>
              <textarea
                ...
                placeholder="Ask about boilers, HVAC, Sundance, Cobalt, Sea-Doo, pool, vendors, photos, documents, service history, locations..."
    ...
    <div>
      ...
      <div style={styles.gridTwo}>
        ...
        <section style={styles.card}>
          ...
          <div style={styles.answerBox}>Service records: {serviceHistory.length}</div>
        </section>
      </div>
    </div>
  );
      ...
      <section style={styles.card}>
        ...
        {calendar.map((event) => (
          <div key={event.id} style={styles.calendarRow}>
            <input value={event.date} onChange={(e) => setCalendar(calendar.map((row) => row.id === event.id ? { ...row, date: e.target.value } : row))} style={styles.input} />
            <input value={event.title} onChange={(e) => setCalendar(calendar.map((row) => row.id === event.id ? { ...row, title: e.target.value } : row))} style={styles.input} />
            <input value={event.notes} onChange={(e) => setCalendar(calendar.map((row) => row.id === event.id ? { ...row, notes: e.target.value } : row))} style={styles.input} />
          </div>
        ))}
      </section>
    </div>
