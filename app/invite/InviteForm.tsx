    ...
    try {
      ...
      if (!response.ok || !payload.ok) {
        setMessage(
          String(
            payload.error ||
              "Atlas could not complete this invitation.",
          ),
        );
        return;
      }
    ...
    >
      ...
      >
        ...
        {!token ? (
          ...
          >
            This invitation link is incomplete. Ask the Atlas
            administrator to create a new invitation.
          </div>
        ) : complete ? (
          <div
            style={{
