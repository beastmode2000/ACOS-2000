                          ...
                          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "minmax(0,1.3fr) minmax(260px,.7fr)", gap: 14 }}>
                            ...
                            <aside style={{ display: "grid", gap: 10, alignContent: "start" }}>
                              ...
                              <div style={{ display: "flex", gap: 7, flexWrap: "wrap" }}>
                                ...
                                <label style={{ ...secondaryButtonStyle, display: "inline-flex", alignItems: "center", justifyContent: "center", cursor: "pointer", margin: 0, width: "auto" }}>Take Photo<input type="file" accept="image/*" capture="environment" style={{ display: "none" }} onChange={(event) => { void addDatedProjectPhotos(event.currentTarget.files); event.currentTarget.value = ""; }} /></label>
                                <label style={{ ...secondaryButtonStyle, display: "inline-flex", alignItems: "center", justifyContent: "center", cursor: "pointer", margin: 0, width: "auto" }}>Upload from Library<input type="file" accept="image/*" multiple style={{ display: "none" }} onChange={(event) => { void addDatedProjectPhotos(event.currentTarget.files); event.currentTarget.value = ""; }} /></label>
                ...
                <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "minmax(0,1.45fr) 380px" }}>
                  ...
                  <aside style={{ padding: 18, display: "grid", gap: 14, alignContent: "start" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(2,minmax(0,1fr))", gap: 8 }}>
                      ...
                      <label style={{ ...secondaryButtonStyle, display: "inline-flex", alignItems: "center", justifyContent: "center", cursor: "pointer", margin: 0 }}>Take Replacement Photo<input type="file" accept="image/*" capture="environment" style={{ display: "none" }} onChange={(event) => { const file = event.target.files?.[0]; if (file) void replaceSelectedTimelinePhoto(file); event.currentTarget.value = ""; }} /></label>
                      <label style={{ ...secondaryButtonStyle, display: "inline-flex", alignItems: "center", justifyContent: "center", cursor: "pointer", margin: 0 }}>Replace from Library<input type="file" accept="image/*" style={{ display: "none" }} onChange={(event) => { const file = event.target.files?.[0]; if (file) void replaceSelectedTimelinePhoto(file); event.currentTarget.value = ""; }} /></label>
