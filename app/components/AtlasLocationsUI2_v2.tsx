...
import AtlasLocationsShell from "./AtlasLocations";

type AtlasLocationsV2Props = Record<string, any>;

export default function AtlasLocationsV2(props: AtlasLocationsV2Props) {
  const {
    Field,
    ListDrawerLayout,
    addAsset,
    ...
    const locationIcon = (location: any) => {
    ...
    const isVagueLocation = (location?: any) =>
      Boolean(
        location &&
          vagueLocationNames.has(normalizeLocationName(location.name)),
      );
    const locationDepth = (location: any) => {
      let depth = 0;
    ...
    const locationPath = (location: any) => {
    ...
    const selectedLocationPath = (() => {
      ...
      const path: any[] = [];
      const visited = new Set<string>();
      let current: any | undefined = selectedLocation;
    ...
    return (
      <AtlasLocationsShell isMobile={isMobile}>
        <ListDrawerLayout
